...
export const followersData = [
    { avatar: avatar1, name: "Albert Einstein", username: "YO_albert", removed: false },
    { avatar: avatar2, name: "Isaac Newton", username: "newton_king", removed: false },
    { avatar: avatar3, name: "Nikola Tesla", username: "tesla_genius", removed: false },
    { avatar: avatar4, name: "Marie Curie", username: "curie_marie", removed: false },
    { avatar: avatar5, name: "Charles Darwin", username: "darwin_origin", removed: false },
    { avatar: avatar6, name: "Galileo Galilei", username: "galileo_star", removed: false },
    { avatar: avatar7, name: "Leonardo da Vinci", username: "da_vinci_art", removed: false },
    { avatar: avatar8, name: "Ada Lovelace", username: "ada_code", removed: false },
];